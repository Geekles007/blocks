      ...
      h(
        'button',
        {
          ...
          style: {
            ...
            cursor: 'pointer',
            color: t.text,
            // Interactive states (see .ib-menubtn in globals.css). Neutral surface
            // lift on hover, accent-tinted press/open, accent focus ring — tuned
            // per theme so contrast holds in both light and dark.
            '--mb-bg-hover': theme === 'dark' ? '#232327' : '#e9e9ec',
            '--mb-bg-active': t.accentSoft,
            '--mb-border-hover': t.borderStrong,
            '--mb-fg-hover': t.text,
            '--mb-accent': t.accent,
            '--mb-ring': t.accentSoft,
            '--mb-ring-color': t.accentRing,
